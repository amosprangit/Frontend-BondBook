...
export default function Reminder({ navigation }: { navigation: any }) {
  ...
  // Delete reminder directly without Alert.alert
  const handleDeleteReminder = async (reminderId: string) => {
    try {
      // Close swipeable action first
      swipeableRefs.current.get(reminderId)?.close();
      ...
      Toast.show({
        ...
        text2: 'The reminder has been deleted successfully',
        position: 'bottom',
      });
      ...
      // Close swipeable if request fails
      swipeableRefs.current.get(reminderId)?.close();

      Toast.show({
        type: 'error',
        text1: 'Delete Failed',
        text2: 'Could not delete the reminder. Please try again.',
        position: 'bottom',
      });
    }
  };

  // Gmail-style swipe delete action
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View
          style={styles.reminderCardsContainer}
        >
          {isLoading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              >
                ...
                <Text style={styles.emptyText}>
                  Stay organized! Create your
                  first reminder to never miss
                  important events.
                </Text>
